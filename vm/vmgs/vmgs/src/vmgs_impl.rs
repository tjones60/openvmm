...
mod tests {
    ...
    async fn empty_vmgs() {
        ...
        let result = Vmgs::open(Box::new(storage), None).await;
    ...
    async fn format_empty_vmgs() {
        ...
        let result = Vmgs::format_new(Box::new(storage), None).await;
        assert!(result.is_ok());
    }
    ...
    async fn basic_read_write() {
        ...
        let mut vmgs = Vmgs::format_new(Box::new(storage), None).await.unwrap();
    ...
    async fn open_existing_file() {
        ...
        let mut vmgs = Vmgs::open(Box::new(storage), None).await.unwrap();
